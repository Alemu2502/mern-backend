...
export const addOrUpdateReview = async (req, res) => {
  try {
    ...
    console.log('Received update request:', { rating, comment, reviewId, userId });
    ...
    if (existingReview) {
      ...
      if (!product) {
        console.log('Product not found:', reviewId);
...
// In your controllers/product.js or similar

export const hasDelivered = async (req, res) => {
    const { productId, userId } = req.params;
    try {
        const productObjectId = new mongoose.Types.ObjectId(productId);
        const userObjectId = new mongoose.Types.ObjectId(userId);

        console.log('Checking for delivered order with:', { productObjectId, userObjectId });

        // Adjust the query to correctly match the document structure
